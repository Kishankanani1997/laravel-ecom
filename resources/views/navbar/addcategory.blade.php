                            ...
                            <form method="post" enctype="multipart/form-data">
                                @csrf
                                    <div class="form-group mt-4 col-md-10 mx-auto">
                                        ...
                                        <input type="text" name="catname" autocpmplete="off" placeholder="Enter Category Name" class="form-control mt-2">
                                    </div>

                                    <div class="col-md-10 mx-auto">
                                        <input type="submit" name="addcategory" value="Addcategory" class="btn btn-success bg bg-success mt-4">
