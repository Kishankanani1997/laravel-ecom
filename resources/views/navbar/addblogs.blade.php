                            ...
                            <form method="post" enctype="multipart/form-data">
                                @csrf
                                    <div class="form-group col-md-10 mx-auto">
                                        ...
                                        <input type="text" name="blogtitle" placeholder="Enter Blog Title" class="form-control">
                                    </div>

                                    <div class="form-group mt-4 col-md-10 mx-auto">
                                        <label>Add Blog</label>
                                        <input type="text" name="addblog" placeholder="Add Your Blog" class="form-control">
                                    </div>
