                            ...
                            <form method="post" enctype="multipart/form-data">
                                @csrf
                                    <div class="form-group mt-4 col-md-10 mx-auto">
                                        <label>*Edit Your Category Name*</label>
                                        <input type="text" name="catename" value="{{$editsubcat->cat_id}}" autocpmplete="off" placeholder="Enter Subcategory Name" class="form-control">
                                    </div>

                                    <div class="form-group mt-4 col-md-10 mx-auto">
                                        <label>*Edit Your SubCategory Name*</label>
                                        <input type="text" name="subcatname" value="{{$editsubcat->subcat_name}}" autocpmplete="off" placeholder="Enter Subcategory Name" class="form-control">
                                    </div>
