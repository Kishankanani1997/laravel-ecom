                                ...
                                <table id="example" class="display table table-responsive" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$row->pro_oldprice}}</td>
                                            <td>{{$row->pro_newprice}}</td>
                                            <td>{{$row->pro_qty}}</td>

                                            <td><a href='{{ URL("/navbar.manageproducts/".$row->id)}}' onclick="return confirm('Are you sure you want to delete?')"><i class="bi bi-trash text-danger"></i></a> | <a href='{{ URL("/navbar.editproducts/".$row->id)}}' onclick="return confirm('Are You Sure You Want to Edit Products?')"><i class="bi bi-pencil text-warning"></i>
                                        </tr>
                                        @endforeach    
                                    </tbody>
                                </table>
