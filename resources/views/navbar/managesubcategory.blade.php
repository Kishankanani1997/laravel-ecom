                                ...
                                <table id="example" class="display table table-responsive" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href='{{ URL("/navbar.managesubcategory/".$row->id)}}' onclick="return confirm('Are you sure you want to delete?')"><i class="bi bi-trash text-danger"></i></a> | <a href='{{ URL("/navbar.editsubcategory/".$row->id)}}' onclick="return confirm('Are You Sure You Want to Edit Subcategory?')"><i class="bi bi-pencil text-warning"></i>
                                        </tr>
                                        @endforeach    
                                    </tbody>
                                </table>
