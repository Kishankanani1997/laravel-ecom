                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <!--here we pass flash data message for delete the blog-->
                            @if(Session('dele'))
                            <div class="alert alert-danger">
                            ...
                            @endif
                             ...
                             @if(Session('blogsuc'))
                                <div class="alert alert-success">
                                    <span class="text-dark">{{ session('blogsuc')}}</span>
                                </div>
                            @endif
                                ...
                                <table id="example" class="display table table-responsive" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$row->addblog}}</td>
                                            <td>{{$row->blogdate}}</td>
                                            <td><img src='{{ asset("assets/uploads/blog/".$row->blogimage)}}' width="70px" height="70px"></td>
                                            <td><a href='{{ URL("/navbar.manageblogs/".$row->id)}}' onclick="return confirm('Are You Sure You Want to Remove BLog?')"><i class="bi bi-trash text-danger"></i></a> |<a href='{{ URL("/navbar.editblogs/".$row->id)}}' onclick="return confirm('Are You Sure You Want to Edit Blog?')"> <i class="bi bi-pencil text-warning"></i></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
