                                ...
                                <table id="example" class="display table table-responsive" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$row->id}}</td>
                                            <td>{{$row->cat_name}}</td>
                                            <td><a href='{{ URL("/navbar.managecategory/".$row->id)}}' onclick="return confirm('Are you sure you want to delete?')"><i class="bi bi-trash text-danger"></i></a> | <a href='{{ URL("/navbar.editcategory/".$row->id)}}' onclick="return confirm('Are You Sure You Want to Edit Category?')"><i class="bi bi-pencil text-warning"></i>
                                        </tr>
                                        @endforeach    
                                    </tbody>
                                </table>
